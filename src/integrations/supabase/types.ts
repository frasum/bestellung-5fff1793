  ...
  public: {
    Tables: {
      ...
      employee_order_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_order_items_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_order_items_submission_id_fkey"
            columns: ["submission_id"]
            isOneToOne: false
            referencedRelation: "employee_order_submissions"
            referencedColumns: ["id"]
          },
        ]
      }
      employee_order_submissions: {
        Row: {
          created_at: string
          id: string
          location_id: string | null
        ...
        Relationships: [
          {
            foreignKeyName: "employee_order_submissions_location_id_fkey"
            columns: ["location_id"]
            isOneToOne: false
            referencedRelation: "locations"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "employee_order_submissions_organization_id_fkey"
            columns: ["organization_id"]
            isOneToOne: false
            referencedRelation: "organizations"
            referencedColumns: ["id"]
